...
/*! \internal \file
 * \brief
 * Implements metatensor MDModule class
 *
...
#include "metatensor_force_provider.h"
...
public:
    ...
    void initForceProviders(ForceProviders* forceProviders) override {
        forceProvider_ = MetatensorForceProvider();

        forceProviders->addForceProvider(&forceProvider_);
    }

private:

    MetatensorForceProvider forceProvider_;
};
